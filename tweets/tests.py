...
class TweetTestCase(TestCase):
    def setUp(self):
        ...
        self.userb = User.objects.create_user(username='def', password='password')
        
        Tweet.objects.create(content="tweet", user=self.user)
        Tweet.objects.create(content="tweet", user=self.user)
        Tweet.objects.create(content="tweet", user=self.userb)
        self.currentCount = Tweet.objects.all().count()
        
    def test_tweet_created(self):
        tweet = Tweet.objects.create(content="tweet", user=self.user)
